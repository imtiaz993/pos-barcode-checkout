  ...
  return (
    <>
      ...
      <div className="min-h-[calc(100dvh-60px-16px)] mx-auto px-2 sm:px-4 py-2">
        <h1 className="mb-3 sm:mb-5 text-lg sm:text-2xl font-semibold text-gray-800 mt-3 sm:mt-4">
          🛒 All Orders
        </h1>
        ...
        <div className="">
          <div className="flex flex-wrap items-center justify-between relative">
            <div className="flex items-center gap-2">
              ...
              >
                <FaFilter className="text-gray-500" /> Order Type:
              </label>
              <select
                id="orderType"
                value={orderType}
                onChange={(e) => setOrderType(e.target.value)}
                className="border px-3 py-2 rounded-lg text-sm bg-gray-50"
              >
              ...
              <table className="w-full text-left border-collapse text-sm sm:text-base">
                <thead className="sticky top-0 bg-gray-100">
                  <tr>
                    ...
                    <th className="p-2 sm:p-4">🛍️ Total</th>
                    <th className="p-2 sm:p-4">🎟️ Coupon</th>
                  ...
                  {orders.length > 0 ? (
                    orders.map((order, index) => (
                      ...
                      >
                        ...
                        <td className="p-2 sm:p-4 whitespace-nowrap">
                          <Link href={`/admin/order-history/${order.orderId}`}>
